...
ActiveRecord::Schema.define(version: 2019_10_04_120123) do
  ...
  create_table "webids", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "name"
    t.string "email"
    ...
    t.string "link"
    t.bigint "user_id"
    t.index ["user_id"], name: "index_webids_on_user_id"
  end
