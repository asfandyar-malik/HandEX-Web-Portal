class ExportApplicationsController < ApplicationController
    ...
    def export_application_params
        params.require(:export_application).permit(:application_type, :application_status, :describe_export_business, :is_investment_good, :explain_why_importer_buying_good, :is_servicing_for_goods_offered, :exported_goods_type, :exported_goods_type_two, :exported_goods_type_three, :exported_goods_type_four, :is_delivered_part_of_consortium_with_other_companies, :delivery_affects_natural_reserves, :delivery_affects_indigenous_people, :delivery_affects_cultural_heritage, :delivery_affects_other, :explain_delivery_affects_other, :is_export_licence_needed, :which_regulations_enforcing_exportlicense_requirement, :export_license_status, :does_deliver_secondhand_goods, :is_contract_already_signed_between_parties, :contract_signing_date, :exporter_internal_contract_id, :has_special_contract_structure, :total_delivery_value_excluding_servicing, :percentage_of_spareparts_in_whole_order, :other_billed_items_in_contract_currency, :other_billed_items_in_contract_amount, :describe_other_billed_items_in_contract, :is_price_adjustment_clause_with_importer, :explain_accounting_methods, :is_good_sent_in_multiple_deliveries, :delivery_start, :delivery_end, :other_important_delivery_information, :other_important_delivery_milestones, :german_certificate_of_origin_status, :all_rawgoods_supplier_country, :all_rawgoods_supplier_currency, :all_rawgoods_supplier_text, :why_all_foreign_rawgoods_necessary, :partly_rawgoods_supplier_country, :partly_rawgoods_supplier_currency, :partly_rawgoods_supplier_text, :why_partly_foreign_rawgoods_necessary, :is_security_present_for_transaction, :security_type, :security_type_name, :proportion_of_good_covered_by_security, :when_security_received, :project_detailed_description, :is_fully_responsible_for_project, :entire_project_currency, :entire_project_amount, :percentage_of_service_in_whole_order, :contract_value, :does_delivery_affect_sensitive_areas, :explain_sensitive_area_type, :are_secondhand_goods_delivered, :explain_special_structure, :degressive_interest_rate, :service_start, :service_end, :availability, :services_not_visible_to_customer,
                                                   ...
                                                   # # Documents ----------------------------------------
                                                   :annual_financial_statement_importer, :annual_financial_statement_importer_second_last, :annual_financial_statement_exporter, :annual_financial_statement_exporter_second_last, :export_contract_or_bills, :credit_bureaus_importer, :self_declaration, :project_memorandum_exporter_business, :environment_social_audit,
                                                   ...
                                                   :advance_payment_description_payment_term_both, :payment_vehichle_payment_term_short, :receive_deposit_time_payment_term_mid, :repayment_structure_payment_term_mid, :loan_term_start_payment_term_mid, :loan_term_other_description_payment_term_mid, :number_of_installments_payment_term_short, :advance_payment_currency_payment_term_both,
                                                   ...
                                                   :business_focus_country_one, :business_focus_country_two, :business_focus_country_three, :business_focus_country_four, :business_focus_country_five,
                                                   :does_pep_exist, :numer_of_pep,
                                                   ...
                                                   guarantees_attributes: Guarantee.attribute_names.map(&:to_sym).push(:_destroy), agreed_payments_attributes: AgreedPayment.attribute_names.map(&:to_sym).push(:_destroy), agreed_payment_mid_longs_attributes: AgreedPaymentMidLong.attribute_names.map(&:to_sym).push(:_destroy), multiple_shipments_attributes: MultipleShipment.attribute_names.map(&:to_sym).push(:_destroy), source_of_funds_attributes: SourceOfFund.attribute_names.map(&:to_sym).push(:_destroy), application_of_funds_attributes: ApplicationOfFund.attribute_names.map(&:to_sym).push(:_destroy), extra_billed_items_attributes: ExtraBilledItem.attribute_names.map(&:to_sym).push(:_destroy),
                                                   special_repayment_profiles_attributes: SpecialRepaymentProfile.attribute_names.map(&:to_sym).push(:_destroy),
                                                   peps_attributes: Pep.attribute_names.map(&:to_sym).push(:_destroy)
